        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Food Menu</h3>
                    <p class="text-subtitle text-muted">Edit Food Menu Baru</p>
                </div>
...
@section('page-content')
    ...
    <section class="section">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ url('food-menu/'.$data->id.'/update') }}" enctype="multipart/form-data" method="post">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control form-select" name="id_cuisine" id="">
                                    @forelse($cuisines as $item)
                                        <option value="{{ $item->id }}" @if($item->id==$data->id_cuisine)
                                            selected @endif>
                                            {{ $item->name }}</option>
                                    @empty
                                    @endforelse
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="desc" id="summernotedisabled" rows="10"
                                          placeholder="Konten Food Menu">{{$data->desc}}</textarea>
                            </div>

                            <div class="form-group">
                                <label for="basicInput">Tersedia ?</label>
                                <select class="form-control form-select" name="is_available">
                                    <option @if($data->is_available==1) selected @endif value="1">Ya</option>
                                    <option @if($data->is_available==0) selected @endif value="0">Tidak</option>
                                </select>
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <img src="{{asset("$data->thumbnail")}}" style="border-radius: 20px" id="imgPreview"
                                 class="img-fluid" alt="Responsive image">
                        </div>

                        <div class="form-group">
                            <label for="basicInput">Tampilkan Kepada Pengguna ?</label>
                            <select class="form-control form-select" name="is_visible" id="">
