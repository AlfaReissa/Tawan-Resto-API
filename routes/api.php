...
use App\Http\Controllers\Tawan\TawanController;
use App\Http\Controllers\FoodCartCacheController;
use App\Http\Controllers\TawanInvoiceController;
...
Route::prefix('tawan')->group(function () {
    $cr = "ApiAuthController";
    Route::get('menu', [TawanController::class, 'getMenu']);
    Route::get('cuisine', [TawanController::class, 'getCuisineCategory']);

    Route::prefix('invoice')->group(function () {
        Route::post('save', [TawanInvoiceController::class, 'store']);
        Route::get('cuisine', [FoodCartCacheController::class, '']);
        Route::any('all', [FoodCartCacheController::class, 'all']);
...
Route::get('user/{id}', [TawanInvoiceController::class, 'user']);
Route::prefix('food-invoice')->group(function () {
    Route::post('save', [TawanInvoiceController::class, 'store']);
    Route::any('user/{id}', [TawanInvoiceController::class, 'getByUser']);
    Route::any('resto/{id}', [TawanInvoiceController::class, 'store']);
});


Route::prefix('food-cart')->group(function () {
    Route::post('save', [FoodCartCacheController::class, 'store']);
    Route::get('cuisine', [FoodCartCacheController::class, '']);
    Route::any('all', [FoodCartCacheController::class, 'all']);
    Route::any('user/{id}', [FoodCartCacheController::class, 'getByUser']);
    Route::any('user/{idUser}/menu/{idMenu}', [FoodCartCacheController::class, 'checkIfAlreadyIn']);
